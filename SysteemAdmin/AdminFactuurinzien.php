            ...
            else
            {
                ...
                <div id="factuur">
                    ...
                    <p>Factuur:
                        ...
                        $btwbedrag = ($subtotal / 100) * $BTW; //Berekening van het btwbedrag
                        $totaal = $subtotal + $btwbedrag; //Totaal berekenen
                        echo "</table><br>";
                        echo "<label class='factuur'>Subtotaal</label>€ $subtotal<br>";
                        ...
                        { //melding wordt getoond a.d.h.v. de betreffende status
